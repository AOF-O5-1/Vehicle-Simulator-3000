...
import wheelie from "./Motorbike.js";
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          // find the selected vehicle and perform a wheelie on it
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
              if (this.vehicles[i] instanceof Motorbike) {
                
                (this.vehicles[i] as Motorbike).wheelie(); // wheelie was not being recognized as a function, so I had to cast the vehicle as a Motorbike
              } else {
